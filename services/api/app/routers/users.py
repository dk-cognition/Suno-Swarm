...
def update_me(
    ...
    Only the profile attributes declared on UserProfileFields can be changed; any other
    key is rejected by the schema.
    """
    for field, value in payload.fields.dict(exclude_unset=True).items():
